...
Cfg.DebugMask=bin2dec('000000');	%bit0=channel mapping out, bit1=fbf in,bit2=beampattern steer out,bit3=source gen filter,bit4=frost beamforming debug,bit5=GJBF debug
Cfg.FixEn=0;	%
...
Cfg.SourceFreq=200;	%only for SourceType=0
Cfg.SourceDuration=1;	%in unit of second,only for SourceType=0 & 2
...
Cfg.SourcePos=[10,140];	%voice source distance and direction
...
Cfg.ANC_W_NormTH=1;	%ANC normalization Threshold
